...
/* remove */
var navHistory = Cc["@mozilla.org/browser/nav-history-service;1"]
                 .getService(Ci.nsINavHistoryService);

var historyObserver = {
  onTitleChanged : function(uri, title) { console.log("title changed to " + title); }
}

exports.main = function (options, callbacks) {
  if(options.loadReason == "install")
    prefs.set("extensions.showsearchterms.mod", "title");
  navHistory.addObserver(historyObserver, false);
};
